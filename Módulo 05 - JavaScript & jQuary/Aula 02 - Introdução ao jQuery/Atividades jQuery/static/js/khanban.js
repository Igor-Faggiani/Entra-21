...
//         const $newTask = $("<div></div>").addClass("khanban-item")
//         const $taskText = $("<span></span>").text(description)
//         const $editButton = createIconButton("bi bi-pencil", "btn btn-waring btn-sm", () => {
...
//         // Cancelar o comportamento padrão do envio do formulário (recarregar a pagina)
